...
import { checkAccess, getAccessibleDomains, getUserBadge, getRoleClearance } from "./badgeData";
import { loadUsers, saveUsers, generateMockHash, addAuditEntry, generateUserId } from "./userData";
