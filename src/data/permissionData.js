...
const DEFAULT_MODULE_PERMISSIONS = {
  ...
  development: {
    ...
    delete:    { level: 3, roles: ["CEO", "VP Engineering"] },
    export:    { level: 3, roles: [] },
    configure: { level: 3, roles: ["CEO", "VP Engineering"] },
  ...
  operations: {
    ...
    configure: { level: 3, roles: ["VP Operations", "CEO"] },
  },
  finance: {
    view:      { level: 3, roles: ["CEO", "COO", "VP Finance", "VP Strategy"] },
    edit:      { level: 3, roles: ["VP Finance", "CEO"] },
    export:    { level: 4, roles: ["CEO", "VP Finance"] },
    configure: { level: 4, roles: ["CEO", "VP Finance"] },
    investor:  { level: 4, roles: ["CEO", "VP Finance", "VP Strategy"] },
    board:     { level: 5, roles: ["CEO"] },
  },
  technology: {
    view:      { level: 1, roles: [] },
  ...
  workforce: {
    ...
    edit:      { level: 3, roles: ["VP People", "VP Risk", "CEO"] },
    export:    { level: 4, roles: ["CEO", "VP People", "VP Risk"] },
    configure: { level: 3, roles: [] },
    compensation: { level: 4, roles: ["CEO", "VP People", "VP Finance"] },
    hrRecords: { level: 4, roles: ["CEO", "VP People"] },
  },
  risk: {
    ...
    configure: { level: 3, roles: ["VP Risk", "CEO"] },
  },
  org: {
    view:      { level: 1, roles: [] },
    edit:      { level: 4, roles: ["CEO", "VP People"] },
  ...
  settings: {
    ...
    edit:      { level: 3, roles: ["CEO", "COO"] },
    configure: { level: 4, roles: ["CEO"] },
    apiKeys:   { level: 5, roles: ["CEO"] },
...
const DEFAULT_VP_DASHBOARD_ACCESS = {
  "ceo-dashboard":   { level: 4, roles: ["CEO"] },
